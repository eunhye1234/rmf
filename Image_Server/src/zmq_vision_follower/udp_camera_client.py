...
model = YOLO('yolo11n.pt')  # 사전학습된 YOLO 모델 로드
                        ...
                        if frame_data:
                            try:
                                ...
                                if frame is not None:
                                    ...
                                    results = model.predict(source=frame, show=False)  #frame은 BGR 이미지
                                    ...
                                    cv2.imshow('PiCamera2 Multicast Stream - Object Detection', annotated_frame)
